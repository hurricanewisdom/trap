...
export const CATEGORIES: CategoryDoc[] = [
  ...
  },
  {
    ...
    label: "Confessions",
    emoji: "",
    blurb: "Anonymous confessions submitted through a button",
  },
  {
    slug: "counting",
    label: "Counting",
    emoji: "",
    blurb: "A counting game in a channel",
  },
  {
    slug: "counter",
    label: "Counters",
...
export const DOCS: CommandDoc[] = [
  ...
  },
  {
    ...
    usage: ",confessions",
    summary: "Anonymous confessions, submitted through a button",
    details:
      "A panel message carries a button; pressing it opens a modal, and what somebody types there is posted to the confession channel under a number, with no name attached. Five things can stop a submission and each says which: a blacklist, a minimum account age read out of the account's own snowflake, a per-member cooldown, a word filter, and the link and image-link settings. With a review channel set, a confession waits there behind Approve and Deny instead of posting straight away, and whether the reviewers see who sent it is what confessions anonymous decides. A log channel is the one place the author is named, whatever the other settings say. Confessions carry a reply button whose replies go through exactly the same checks, or that button can be removed entirely. Aliases: ,confession, ,conf and ,cnf.",
    examples: [",confessions channel #confessions", ",confessions panel", ",confessions settings"],
    permission: "Manage Server",
    guildOnly: true,
    subcommands: [
      { name: "age", usage: ",confessions age <duration>", summary: "Set the minimum account age required to submit confessions", permission: "Manage Server" },
      { name: "age remove", usage: ",confessions age remove", summary: "Remove the minimum account age required", permission: "Manage Server" },
      { name: "age view", usage: ",confessions age view", summary: "View the current minimum account age required", permission: "Manage Server" },
      { name: "anonymous", usage: ",confessions anonymous <status>", summary: "Set whether confessions are anonymised during review", permission: "Manage Server" },
      { name: "blacklist", usage: ",confessions blacklist [member or role]", summary: "Blacklist a member or role from submitting", permission: "Manage Server" },
      { name: "blacklist clear", usage: ",confessions blacklist clear", summary: "Remove everyone from the blacklist", permission: "Manage Server" },
      { name: "blacklist view", usage: ",confessions blacklist view", summary: "View the members and roles blacklisted", permission: "Manage Server" },
      { name: "blacklisted", usage: ",confessions blacklisted", summary: "View the members and roles blacklisted", permission: "Manage Server" },
      { name: "button", usage: ",confessions button <style> <label>", summary: "Customise the submit confession button", permission: "Manage Server" },
      { name: "button remove", usage: ",confessions button remove", summary: "Entirely remove the submit confession button", permission: "Manage Server" },
      { name: "button view", usage: ",confessions button view", summary: "View the current submit confession button", permission: "Manage Server" },
      { name: "channel", usage: ",confessions channel <channel>", summary: "Set the channel to forward confessions to", permission: "Manage Server" },
      { name: "channel remove", usage: ",confessions channel remove", summary: "Remove the channel designated for confessions", permission: "Manage Server" },
      { name: "channel view", usage: ",confessions channel view", summary: "View the current confession channel", permission: "Manage Server" },
      { name: "cooldown", usage: ",confessions cooldown <duration>", summary: "Set the cooldown between confessions for each user", permission: "Manage Server" },
      { name: "cooldown remove", usage: ",confessions cooldown remove", summary: "Remove the cooldown", permission: "Manage Server" },
      { name: "cooldown view", usage: ",confessions cooldown view", summary: "View the current cooldown", permission: "Manage Server" },
      { name: "filter", usage: ",confessions filter <word>", summary: "Add or remove a word from the word filter", permission: "Manage Server" },
      { name: "filter status", usage: ",confessions filter status <status>", summary: "Enable or disable the word filter without clearing it", permission: "Manage Server" },
      { name: "filter view", usage: ",confessions filter view", summary: "View words that are being filtered", permission: "Manage Server" },
      { name: "images", usage: ",confessions images <status>", summary: "Set whether confessions can contain image links", permission: "Manage Server" },
      { name: "links", usage: ",confessions links <status>", summary: "Set whether confessions can contain links", permission: "Manage Server" },
      { name: "log", usage: ",confessions log <channel>", summary: "Set the channel to log confessions to", permission: "Manage Server" },
      { name: "log remove", usage: ",confessions log remove", summary: "Remove the channel designated for logging", permission: "Manage Server" },
      { name: "log view", usage: ",confessions log view", summary: "View the current confession log channel", permission: "Manage Server" },
      { name: "panel", usage: ",confessions panel", summary: "Post the confession submission button", permission: "Manage Server" },
      { name: "ping", usage: ",confessions ping <role>", summary: "Add or remove a role pinged in the confession message", permission: "Manage Server" },
      { name: "ping clear", usage: ",confessions ping clear", summary: "Remove all roles being pinged", permission: "Manage Server" },
      { name: "ping remove", usage: ",confessions ping remove <role>", summary: "Remove a role from being pinged", permission: "Manage Server" },
      { name: "ping view", usage: ",confessions ping view", summary: "View the roles being pinged", permission: "Manage Server" },
      { name: "reply", usage: ",confessions reply <script>", summary: "Set the script used to render replies", permission: "Manage Server" },
      { name: "reply remove", usage: ",confessions reply remove", summary: "Reset the reply script to the default", permission: "Manage Server" },
      { name: "replybutton", usage: ",confessions replybutton <style> <label>", summary: "Customise the reply button", permission: "Manage Server" },
      { name: "replybutton remove", usage: ",confessions replybutton remove", summary: "Entirely remove the reply button", permission: "Manage Server" },
      { name: "replybutton view", usage: ",confessions replybutton view", summary: "View the current reply button", permission: "Manage Server" },
      { name: "review", usage: ",confessions review <channel>", summary: "Set the channel to review confessions in", permission: "Manage Server" },
      { name: "review ping", usage: ",confessions review ping <role>", summary: "Add a role notified when a confession is under review", permission: "Manage Server" },
      { name: "review ping clear", usage: ",confessions review ping clear", summary: "Remove all roles notified about reviews", permission: "Manage Server" },
      { name: "review ping remove", usage: ",confessions review ping remove <role>", summary: "Remove a role from review notifications", permission: "Manage Server" },
      { name: "review ping view", usage: ",confessions review ping view", summary: "View the roles notified about reviews", permission: "Manage Server" },
      { name: "review remove", usage: ",confessions review remove", summary: "Remove the channel designated for reviewing", permission: "Manage Server" },
      { name: "review view", usage: ",confessions review view", summary: "View the current confession review channel", permission: "Manage Server" },
      { name: "settings", usage: ",confessions settings", summary: "View the current confessions configuration", permission: "Manage Server" },
      { name: "template", usage: ",confessions template <script>", summary: "Set the script used to render confessions", permission: "Manage Server" },
      { name: "template remove", usage: ",confessions template remove", summary: "Reset the confession script to the default", permission: "Manage Server" },
    ],
  },
  {
    name: "counting",
    category: "counting",
    usage: ",counting",
    summary: "Run a counting game in a channel",
    details:
      "Members count upwards, one number per message; a correct one gets a tick and a wrong one breaks the count. Nine toggles change how it plays -- math lets 5+6 count as 11, repeat allows the same person twice in a row, resetonfail decides whether a mistake starts again, and there are toggles for deleting invalid messages, deleting everything else, guarding edits, and announcing resets, records and milestones. Lives absorb mistakes before a reset, a step sets how much each count rises by, a goal can hand out a role, and milestones can be posted and pinned every so often. Aliases: ,number and ,numb -- not ,count, which belongs to Last.fm.",
    examples: [",counting setup #counting", ",counting toggle #counting math", ",counting leaderboard"],
    permission: "Manage Server",
    guildOnly: true,
    subcommands: [
      { name: "leaderboard", usage: ",counting leaderboard [channel]", summary: "View the top counters for a counting channel", permission: "Manage Server" },
      { name: "list", usage: ",counting list", summary: "View all counting channels configured in this server", permission: "Manage Server" },
      { name: "remove", usage: ",counting remove <channel>", summary: "Stop a channel from being used for counting", permission: "Manage Server" },
      { name: "reset", usage: ",counting reset <channel>", summary: "Manually reset the count back to 0", permission: "Manage Server" },
      { name: "set", usage: ",counting set", summary: "Configure values for a counting channel", permission: "Manage Server" },
      { name: "set cooldown", usage: ",counting set cooldown <channel> <seconds>", summary: "Set a per-user cooldown between counts", permission: "Manage Server" },
      { name: "set current", usage: ",counting set current <channel> <value>", summary: "Manually set the current count", permission: "Manage Server" },
      { name: "set emoji", usage: ",counting set emoji <channel> <success|fail> <emoji>", summary: "Set the reaction used for correct or incorrect counts", permission: "Manage Server" },
      { name: "set goal", usage: ",counting set goal <channel> [number] [role] [message]", summary: "Set a target number for the count to reach", permission: "Manage Server" },
      { name: "set lives", usage: ",counting set lives <channel> <amount>", summary: "Set how many mistakes are allowed before a reset", permission: "Manage Server" },
      { name: "set milestone", usage: ",counting set milestone <channel> [interval] [template]", summary: "Set how often milestone messages are sent", permission: "Manage Server" },
      { name: "set role", usage: ",counting set role <channel> [role]", summary: "Restrict counting to a specific role", permission: "Manage Server" },
      { name: "set step", usage: ",counting set step <channel> <value>", summary: "Set how much each correct count must increase by", permission: "Manage Server" },
      { name: "setup", usage: ",counting setup <channel> [start=0] [step=1]", summary: "Turn a channel into a counting channel", permission: "Manage Server" },
      { name: "toggle", usage: ",counting toggle <channel> <setting>", summary: "Toggle a boolean counting setting on or off", permission: "Manage Server" },
      { name: "view", usage: ",counting view <channel>", summary: "View a counting channel's progress and settings", permission: "Manage Server" },
    ],
  },
  {
    name: "counter",
    category: "counter",
    usage: ",counter",
    summary: "Channels that show a live figure in their name",
    details:
      "A counter renames a channel on a timer so its name is always a current number. counter add tracks this server; the platform commands track one account somewhere else. Templates take variables in braces, a |human or |comma filter on any number, and {if: condition && when true && when false}. Discord allows only two renames per channel per ten minutes -- measured, not documented -- so a counter updates every ten minutes and an unchanged name is not sent at all. A text channel lowercases its name and turns spaces into dashes, so a counter reads properly on a voice channel or a category. YouTube, SoundCloud, SoundCloud tracks, TikTok and Twitch can be read with no credentials; Spotify, Instagram and Twitter cannot, and those commands say so rather than making a channel that never changes. Aliases: ,cntr and ,counters.",
    examples: [",counter add #stats {members} members", ",counter preview {members|human} members", ",counter twitch #live shroud"],
    permission: "Manage Server",
    guildOnly: true,
    subcommands: [
      { name: "add", usage: ",counter add [channel] [template]", summary: "Add or update a counter channel with a custom template", permission: "Manage Server" },
      { name: "clear", usage: ",counter clear", summary: "Remove all counter channels configured in this server", permission: "Manage Server" },
      { name: "list", usage: ",counter list", summary: "View all counter channels and their templates", permission: "Manage Server" },
      { name: "preview", usage: ",counter preview <template>", summary: "Preview what a template would resolve to", permission: "Manage Server" },
      { name: "refresh", usage: ",counter refresh <channel>", summary: "Force-update a counter channel immediately", permission: "Manage Server" },
      { name: "remove", usage: ",counter remove <channel>", summary: "Stop a channel from being updated as a counter", permission: "Manage Server" },
      { name: "socialvars", usage: ",counter socialvars [platform]", summary: "View the template variables for social counter platforms", permission: "Manage Server" },
      { name: "variables", usage: ",counter variables", summary: "View all available template variables", permission: "Manage Server" },
      { name: "view", usage: ",counter view <channel>", summary: "View the template for a counter channel", permission: "Manage Server" },
      { name: "youtube", usage: ",counter youtube [channel] <handle> [template]", summary: "Track a YouTube channel's subscribers", permission: "Manage Server" },
      { name: "soundcloud", usage: ",counter soundcloud [channel] <username> [template]", summary: "Track a SoundCloud user's followers", permission: "Manage Server" },
      { name: "soundcloudtrack", usage: ",counter soundcloudtrack [channel] <url> [template]", summary: "Track a SoundCloud track's play count", permission: "Manage Server" },
      { name: "tiktok", usage: ",counter tiktok [channel] <username> [template]", summary: "Track a TikTok account's followers", permission: "Manage Server" },
      { name: "twitch", usage: ",counter twitch [channel] <username> [template]", summary: "Track a Twitch streamer's live stats", permission: "Manage Server" },
  ...
  },
  {
    ...
    details:
      "Changes what the bot looks like and sounds like in this server only; every other server keeps seeing its usual avatar, banner and name. Beyond the profile, customize response gives each of four kinds of card its own emoji and colour -- default is nearly every card the bot sends and warn is every permission refusal, so those two are visible everywhere at once; approve and loading are used by commands that report those states. customize ping decides whether an ordinary reply may mention anybody, and customize punctuation whether a card ends in a full stop. Discord rations avatar and banner changes hard and refuses further ones for a while, and the command passes that reason on rather than reporting a generic failure. It will accept a bio and never hand it back to a bot, so the bio shown is the one last set through this command. Server Owner only. Alias: ,customise.",
    examples: [",customize", ",customize response warn ⛔ red", ",customize punctuation off"],
    permission: "Server Owner",
    guildOnly: true,
    subcommands: [
      { name: "avatar", usage: ",customize avatar [attachment]", summary: "Change the bot's avatar", permission: "Server Owner" },
      { name: "avatar remove", usage: ",customize avatar remove", summary: "Reset the bot's avatar to default", permission: "Server Owner" },
      { name: "banner", usage: ",customize banner [attachment]", summary: "Change the bot's banner", permission: "Server Owner" },
      { name: "banner remove", usage: ",customize banner remove", summary: "Remove the bot's banner", permission: "Server Owner" },
      { name: "bio", usage: ",customize bio <bio>", summary: "Change the bot's bio", permission: "Server Owner" },
      { name: "display", usage: ",customize display <nickname>", summary: "Change the bot's display name", permission: "Server Owner" },
      { name: "display reset", usage: ",customize display reset", summary: "Reset the bot's display name to default", permission: "Server Owner" },
      { name: "ping", usage: ",customize ping <status>", summary: "Toggle whether the bot mentions users in its responses", permission: "Server Owner" },
      { name: "punctuation", usage: ",customize punctuation <status>", summary: "Toggle whether responses end in a full stop", permission: "Server Owner" },
      { name: "reset", usage: ",customize reset", summary: "Reset the bot's profile to default", permission: "Server Owner" },
      { name: "response", usage: ",customize response", summary: "Customize the responses by the bot", permission: "Server Owner" },
      { name: "response approve", usage: ",customize response approve [emoji] [color]", summary: "The response used for approval messages", permission: "Server Owner" },
      { name: "response default", usage: ",customize response default [emoji] [color]", summary: "The default response for neutral messages", permission: "Server Owner" },
      { name: "response loading", usage: ",customize response loading [emoji] [color]", summary: "The response used for loading messages", permission: "Server Owner" },
      { name: "response reset", usage: ",customize response reset", summary: "Reset the custom responses to their defaults", permission: "Server Owner" },
      { name: "response warn", usage: ",customize response warn [emoji] [color] [soft=False]", summary: "The response used for warnings", permission: "Server Owner" },
    ],
  },
  {
    name: "suggest",
